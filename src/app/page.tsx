...
export default function BacXLanding() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-blue-100 px-6 md:px-20 font-sans text-slate-900">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              ...
              className="bg-gradient-to-r from-blue-400 to-blue-500 text-white px-10 py-3 rounded-full font-bold shadow-lg shadow-blue-200 hover:scale-105 transition-transform"
            >
              Login
            </Link>
            <Link
              href="/auth?mode=signup"
              className="bg-gradient-to-r from-blue-300 to-blue-400 text-white px-10 py-3 rounded-full font-bold shadow-lg shadow-blue-100 hover:scale-105 transition-transform"
            >
              Sign Up
            </Link>
          </div>
