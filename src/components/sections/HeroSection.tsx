...
export function HeroSection() {
    ...
    return (
        ...
        >
            ...
            {/* Neural Background Effects - Paused if not visible */}
            {isVisible && <NeuralBackground />}

            {/* Animated Floating Elements — GPU Accelerated */}
            {isVisible && (
                <>
                    <motion.div
            ...
            <div className="relative z-10 max-w-4xl mx-auto mt-16 w-full">
                ...
                >
                    ...
                    <h1 className="relative z-10 text-6xl md:text-8xl font-serif text-white mb-8 leading-tight drop-shadow-2xl transform-gpu translate-z-0">
