...
export default function RightGlassSidebar() {
  ...
  return (
    <>
      ...
      {isExiting && (
        <div className="fixed inset-0 z-[100] bg-black animate-in fade-in duration-700 pointer-events-none" />
      )}
      ...
      >
        ...
        {/* Logout Section */}
        <div className="px-3 mt-2 pt-2 border-t border-white/5 mx-4">
          <button
            onClick={handleLogout}
            className={`w-full relative flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all duration-300 group overflow-hidden text-red-400/70 hover:text-red-400 hover:bg-red-500/10 hover:shadow-[0_0_20px_rgba(239,68,68,0.15)]`}
          >
