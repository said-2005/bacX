...
// FORCE NATIVE NAVIGATION - Bypasses frozen Next.js router
    ...
    return (
        <div className="w-full h-full flex flex-col bg-transparent relative z-[70] pointer-events-auto">
                        ...
                        {isSubjectsOpen && (
                            ...
                            >
                                {subjects.map((subject) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <a
                                                href={subjectHref}
                                                onClick={(e) => { e.preventDefault(); navigateTo(subjectHref); }}
                                                className={cn(
                                ...
                                >
                                    <a
                                        href="/subjects"
                                        onClick={(e) => { e.preventDefault(); navigateTo('/subjects'); }}
            ...
            <div className="p-6 relative z-10">
                <a
                    href="/subscription"
                    onClick={(e) => { e.preventDefault(); navigateTo('/subscription'); }}
