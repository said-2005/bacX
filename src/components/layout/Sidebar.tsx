...
/**
 * SIDEBAR - Isolated Client Component
 * 
 * ARCHITECTURE RULES:
 * 1. Uses standard Next.js <Link> with prefetch={false}
 * 2. NO router.push() - Let Next.js handle navigation naturally
 * 3. NO useTransition for nav - Causes React 19 deadlocks
 * 4. Wrapped in memo() to prevent unnecessary re-renders
 * 5. Only local state: isSubjectsOpen toggle
 */
                            ...
                            >
                                ...
                                <Icon
                                    className={cn(
                                        ...
                                        isActive
                                            ? "text-primary drop-shadow-[0_0_8px_rgba(37,99,235,0.5)]"
                    ...
                    {isSubjectsOpen && (
                        <div className="space-y-1 overflow-hidden">
                            {subjects.map((subject) => {
                                ...
                                return (
                                    <Link
                                        ...
                                        prefetch={false}
                                        className={cn(
                                            "relative flex items-center gap-4 px-6 py-3 rounded-xl transition-all duration-300 group mr-4",
                                            isActive
                            ...
                            <Link
                                href="/subjects"
                                prefetch={false}
                                className="relative flex items-center gap-4 px-6 py-3 text-sm text-primary/70 hover:text-primary transition-colors mr-4"
                            >
                ...
                {role === "admin" && (
                    <div className="pt-4 border-t border-white/5 mx-4">
                        <Link
                            ...
                            prefetch={false}
                            className={cn(
                                "relative flex items-center gap-4 px-6 py-3.5 rounded-xl transition-all duration-300 group",
                    ...
                    <div className="relative flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-white/50 leading-relaxed">
                                افتح جميع الدروس والتمارين الآن
                            </p>
                        </div>
                    </div>
                </Link>
